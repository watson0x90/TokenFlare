...
OAUTH_URLS: Dict[str, str] = {
    'office_foci': '/common/oauth2/v2.0/authorize?client_id=d3590ed6-52b3-4102-aeff-aad2292ab01c&redirect_uri=https%3A%2F%2Flogin.microsoftonline.com%2Fcommon%2Foauth2%2Fnativeclient&response_type=code&scope=openid+offline_access+https%3A%2F%2Fgraph.microsoft.com%2F.default',
    'office_foci_oob': '/common/oauth2/v2.0/authorize?client_id=d3590ed6-52b3-4102-aeff-aad2292ab01c&redirect_uri=urn%3Aietf%3Awg%3Aoauth%3A2.0%3Aoob&response_type=code&scope=openid+offline_access+https%3A%2F%2Fgraph.microsoft.com%2F.default',
    ...
    'teams_foci': '/common/oauth2/v2.0/authorize?client_id=1fec8e78-bce4-4aaf-ab1b-5451cc387264&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient&response_type=code&scope=openid+offline_access+https%3A%2F%2Fgraph.microsoft.com%2F.default',
...
OAUTH_DISPLAY_NAMES: Dict[str, str] = {
    'office_foci': 'Microsoft Office (FOCI, recommended) — nativeclient redirect',
    'office_foci_oob': 'Microsoft Office (FOCI, fallback) — urn:oob redirect (use if nativeclient fails)',
    'azpowershell_foci': 'Azure PowerShell (FOCI) — Graph access, common for admin scenarios',
    'teams_foci': 'Microsoft Teams (FOCI) — broad consent, good alternative to Office',
    'intune_foci': 'Microsoft Intune (FOCI) — refresh token, Conditional Access device bypass testing',
